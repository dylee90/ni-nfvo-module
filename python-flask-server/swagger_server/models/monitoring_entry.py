...
class MonitoringEntry(Model):
    ...
    def __init__(self, timestamp: datetime=None, component_type: str=None, component_id: int=None, measurement_type: str=None, measurement_value: float=None):  # noqa: E501
